  ...
  <div class="shell">
    ...
    <div class="dropdown-content">
      ...
      <a href="../customer/customerLogin.jsp">CUSTOMER LOGIN</a>
        ...
        <h1 style="color: white;margin-top: 60px;text-align: center;">Edit Details</h1>  
       <form:form method="POST" action="/spring_mvc_employee/editsave">    
        <table style="margin:0 auto;color: white;margin-top: 50px;width: 400px;">    
        <tr>  
        <td></td>    
         <td><form:hidden  path="id" /></td>  
         </tr>   
         <tr>    
          <td style="height: 40px;text-align: left;font-size: 17px;font-weight: 500;">Card Number : </td>   
          <td ><form:input path="cardno" readonly="readonly"/></td>  
         </tr>   
          <tr>    
          <td style="height: 40px;text-align: left;font-size: 17px;font-weight: 500;">Name :</td>    
          <td><form:input path="name" readonly="readonly"/></td>  
         </tr>    
         <tr>    
          <td style="height: 40px;text-align: left;font-size: 17px;font-weight: 500;">Aadhar Number :</td>    
          <td><form:input path="aadharno" /></td>  
         </tr>      
         <tr>    
          <td> </td>    
          <td><input type="submit" style="background: none;padding: 7px 15px;color: white;margin-top: 40px;" value="Edit Save" /></td>    
         </tr>    
        </table>    
       </form:form>    
