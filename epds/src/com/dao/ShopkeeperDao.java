...
public class ShopkeeperDao {
	public static ShopkeeperLogin validateAdmin(ShopkeeperLogin user1)
	{
	       ...
	       PreparedStatement ps=null;
			...
			System.out.println(user1.getPshopid());
	         ...
	         if(resultSet.next()) {
	        	 ...
	        	 System.out.println("dao class");
	        	 user2.setUshopid(resultSet.getString("SHOPNO"));
	        	 user2.setPshopid(resultSet.getString("PASSWORD"));
		...
		{
			System.out.println("**Error** ShopkeeperloginDao:validateAdmin "+e.getMessage());
		}
